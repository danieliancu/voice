...
const homeTexts = {
  en: {
    title: "English Correction Assistant",
    subtitle:
      "Hello! I’m your English correction assistant. Just tap the Talk or Write button below and I’ll help you correct your sentences.",
  },
  fr: {
    title: "Assistant de correction d’anglais",
    subtitle:
  ...
  return (
    <LanguageContext.Provider
      value={{
        ...
        home: homeTexts[language] || homeTexts.en,
